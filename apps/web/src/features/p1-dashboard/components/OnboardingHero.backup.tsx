            ...
            <div className="grid grid-cols-2 gap-3 pb-6">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                      progress.scan >= 100 ? "bg-green-500" : pipelineState === "scanning" ? "bg-blue-500" : "bg-slate-400"
                    }`}>
                      <Crosshair className="w-4 h-4 text-white" weight="bold" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 text-sm">Auto-Diagnostic</h3>
                      <span className="text-[10px] text-slate-400">Mesh Analysis</span>
                    </div>
                  </div>
                  <span className="text-[10px] px-2 py-0.5 bg-slate-100 rounded-full text-slate-500">~5s</span>
                </div>
                ...
                <div className="mb-2.5">
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="font-medium text-slate-700">{progress.scan >= 100 ? "100%" : `${progress.scan.toFixed(0)}%`}</span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-1.5 mb-3 text-center">
                  <div className={`rounded-lg py-1.5 bg-white border ${progress.scan >= 100 ? "border-green-200" : "border-amber-200"}`}>
                  ...
                  <div className={`rounded-lg py-1.5 bg-white border ${progress.scan >= 100 ? "border-green-200" : "border-amber-200"}`}>
                    ...
                    <span className="text-[8px] text-slate-500">Holes</span>
                  </div>
                  <div className={`rounded-lg py-1.5 bg-white border ${progress.scan >= 100 ? "border-green-200" : "border-amber-200"}`}>
                    <p className={`text-sm font-bold ${progress.scan >= 100 ? "text-green-600" : "text-amber-600"}`}>
                      {progress.scan >= 100 ? "0" : "4"}
                    </p>
                    <span className="text-[8px] text-slate-500">Normals</span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                      progress.repair >= 100 ? "bg-green-500" : pipelineState === "repairing" ? "bg-purple-500" : "bg-slate-400"
                    }`}>
                      <MagicWand className="w-4 h-4 text-white" weight="bold" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 text-sm">AI Auto-Heal</h3>
                      <span className="text-[10px] text-slate-400">Mesh Repair</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-2 text-xs">
                  <div className="bg-white border border-slate-200 rounded-lg px-3 py-2">
                    ...
                    <p className="font-medium text-slate-700">LibIGL</p>
                  </div>
                  <div className="bg-white border border-slate-200 rounded-lg px-3 py-2">
                    <span className="text-slate-400 text-[10px]">Precision</span>
                    <p className="font-medium text-slate-700">High</p>
                  </div>
                </div>

                {/* Issues Fixed */}
                <div className={`rounded-lg py-2 px-3 mb-2 bg-white border ${progress.repair >= 100 ? "border-green-200" : "border-slate-200"}`}>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-500">Issues Fixed</span>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                      progress.render >= 100 ? "bg-green-500" : pipelineState === "rendering" ? "bg-cyan-500" : "bg-slate-400"
                    }`}>
                      <Cpu className="w-4 h-4 text-white" weight="bold" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 text-sm">Cloud Render</h3>
                ...
                <div className="flex gap-2 mb-2 text-xs">
                  <div className="bg-white border border-slate-200 rounded-lg px-3 py-2 flex-1">
                    ...
                    <p className="font-medium text-slate-700">A100</p>
                  </div>
                  <div className="bg-white border border-slate-200 rounded-lg px-3 py-2 flex-1">
                    <span className="text-slate-400 text-[10px]">Samples</span>
                    <p className="font-medium text-slate-700">1024</p>
                  </div>
                  <div className="bg-white border border-slate-200 rounded-lg px-3 py-2 flex-1">
                    <span className="text-slate-400 text-[10px]">Resolution</span>
                    <p className="font-medium text-slate-700">4K</p>
                  </div>
                  <div className={`rounded-lg px-3 py-2 flex-1 bg-white border ${progress.render >= 100 ? "border-green-200" : "border-slate-200"}`}>
                ...
                <div className="grid grid-cols-3 gap-2 mb-2">
                  <div className={`rounded-lg py-1.5 text-center bg-white border ${progress.render >= 100 ? "border-green-200" : "border-slate-200"}`}>
                    <p className={`text-sm font-bold ${progress.render >= 100 ? "text-green-600" : "text-slate-400"}`}>
                      {progress.render >= 100 ? "1024" : "0"}
                    </p>
                    <span className="text-[8px] text-slate-500">Samples Done</span>
                  </div>
                  <div className={`rounded-lg py-1.5 text-center bg-white border ${progress.render >= 100 ? "border-green-200" : "border-slate-200"}`}>
                    <p className={`text-sm font-bold ${progress.render >= 100 ? "text-green-600" : "text-slate-400"}`}>
                      {progress.render >= 100 ? "3.2s" : "---"}
                    </p>
                    <span className="text-[8px] text-slate-500">Render Time</span>
                  </div>
                  <div className={`rounded-lg py-1.5 text-center bg-white border ${progress.render >= 100 ? "border-green-200" : "border-slate-200"}`}>
                    <p className={`text-sm font-bold ${progress.render >= 100 ? "text-green-600" : "text-slate-400"}`}>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-lg bg-emerald-500 flex items-center justify-center">
                      <Leaf className="w-4 h-4 text-white" weight="bold" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 text-sm">CO₂ Estimate</h3>
                ...
                {/* CO2 Value */}
                <div className="text-center py-2 bg-white border border-emerald-200 rounded-lg mb-2">
                  <span className="text-2xl font-bold text-emerald-600">0.2g</span>
                  <p className="text-[10px] text-slate-500">CO₂ Emitted</p>
                </div>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-lg bg-amber-500 flex items-center justify-center">
                      <Wallet className="w-4 h-4 text-white" weight="bold" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-800 text-sm">Cost Estimate</h3>
                ...
                {/* Total */}
                <div className="bg-white border border-amber-200 rounded-lg p-2 mb-2">
                  <div className="flex justify-between items-center">
